...
async fn test_get_initial_state_with_previous_state() -> Result<()> {
    let mut log = BTreeMap::new();
    log.insert(1, build_blank_entry(1));

    let sm = MemStoreStateMachine {
        // Just stubbed in for testing.
        last_applied_log: 1,
        ..Default::default()
    };
    let hs = HardState {
...
fn default_store_with_logs() -> MemStore {
    let mut log = BTreeMap::new();
    log.insert(1, build_blank_entry(1));
    log.insert(2, build_blank_entry(2));
    log.insert(3, build_blank_entry(3));
    log.insert(4, build_blank_entry(4));
    log.insert(5, build_blank_entry(5));
    log.insert(6, build_blank_entry(6));
    log.insert(7, build_blank_entry(7));
    log.insert(8, build_blank_entry(8));
    log.insert(9, build_blank_entry(9));
    log.insert(10, build_blank_entry(10));
