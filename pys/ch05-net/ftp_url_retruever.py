#!/usr/bin/python2
# -*- coding:utf-8 -*-
'''fetch file from a ftp server
Usage:
$ python2 ftp_url_retruever.py -a mirrors.ustc.edu.cn \
-r /centos/6.4/isos/i386/sha256sum.txt -l sha256sum.txt

or more: -u username -p password
'''
