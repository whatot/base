...
def dictify_logline(line):
    '''return a dictionary of the pertinent pieces of an apache
    combined log file Currently, the only fielfs we are interested
...
def generate_log_report(logfile):
    ...
    to each remote host for each hit on the webserser.
    '''
    report_dict = {}
    for line in logfile:
