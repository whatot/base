...
to parse.It takes parses the log file and generates a report which
associates remote hosts with numbers of bytes transferred to them.
"""
...
def generate_log_report(logfile):
    ...
    This function takes a file object, iterates through all the lines
    in the file, and generates a report of the number of bytes transferred
    to each remote_host for each hit on the webserver.
    '''
    report_dict = {}
    for line in logfile:
